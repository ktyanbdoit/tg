...
#def send(msg, phone, intid, sender):
def send(msg, phone, intid, sender):

    url = "http://10.79.4.29:8080/eai_rus/start.swe?SWEExtSource=WebService&SWEExtCmd=Execute&WSSOAP=1"
                     ...
                     <SiebelMessage>
                        <ser1:ListOfServiceRequestIo>
                           ...
                           <ser1:ServiceRequest>
                              ...
                              <!--Optional:-->
                              <ser1:Status>Открыто</ser1:Status>
                              <!--Optional:-->
                              <ser1:Source>Social Media</ser1:Source>
                              <!--Optional:-->
                              <ser1:Sub-Area>""" + sender + """</ser1:Sub-Area>
                              <!--Optional:-->
                              <ser1:IntegrationId>""" + intid + """</ser1:IntegrationId>
                           </ser1:ServiceRequest>
                        </ser1:ListOfServiceRequestIo>
                     </SiebelMessage>
                  </ser:SRInsert>
